...
if __name__ == '__main__':
    ...
    # pool = multiprocessing.Pool(processes = 5) #use all available cores, otherwise specify the number you want as an argument
    ...
    suffix = 'ResultsRandRev/'
    current_directory = os.getcwd()
    results_directory = os.path.join(current_directory, suffix)
    if not os.path.exists(results_directory):
        os.makedirs(results_directory)
    with open(suffix+'TableValCriteo05Emp_'+str(indexToUse)+'.csv', 'w') as csvfile:
